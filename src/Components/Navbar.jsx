      ...
      <nav class="bg-white text-black fixed w-full z-20 top-0 start-0 border-b border-gray-200  ">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          <a
            ...
            class="flex items-center space-x-3 rtl:space-x-reverse w-16"
          >
            <svg
          ...
          <div
            ...
            id="navbar-sticky"
          >
            <ul class="flex flex-col p-4 md:p-0 mt-4 text-black  font-medium border   rounded-lg   md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0     ">
              <li>
                <a
                  href="#"
                  class="block py-2 px-3 text-black    rounded-sm md:bg-transparent md:text-blue-700 md:p-0 md:dark:text-black"
                  aria-current="page"
                >
                  Home
                </a>
              ...
              <li>
                <a
                  href="#"
                  class="block py-2 px-3 text-black  rounded-sm  md:hover:bg-transparent   md:p-0 "
                >
                  About
                </a>
              </li>
